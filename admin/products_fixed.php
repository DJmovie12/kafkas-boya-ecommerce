...
if ($action === 'edit' && $product_id > 0) {
    ...
    // Eğer ürün bulunamadıysa listeye dön
    if (!$product) {
        $action = 'list';
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                <?php if (empty($products)): ?>
                                    <tr>
                                        <td colspan="6" class="text-center py-4 text-muted">Henüz ürün eklenmemiş</td>
                                    </tr>
                                <?php else: ?>
                                    <?php foreach ($products as $prod): ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="products.php?delete=<?php echo $prod['id']; ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('Emin misiniz?')">
